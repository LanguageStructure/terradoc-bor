# terradoc-bor: Repositório de Áudios Bororo

Este repositório contém arquivos de áudio em língua **Bororo**, utilizados em plataformas digitais, materiais educacionais, documentação linguística, descrição gramatical e pesquisas acadêmicas vinculadas ao projeto **Plataformas Indígenas**.
...
- artigos acadêmicos;
- tecnologias de fala;
- modelos de linguagem para línguas de baixo recurso.
...
**Versão atual:** v1.0.0  
**DOI:** 10.5281/zenodo.10.5281/zenodo.20004069  
